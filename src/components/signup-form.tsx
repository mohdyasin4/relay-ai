...
import { Mail, Lock, User, Eye, EyeOff, CheckIcon, XIcon, Loader2 } from "lucide-react"
...
export function SignupForm({
  ...
  const validateForm = (): { isValid: boolean; errors: Record<string, string> } => {
    try {
      registerSchema.parse({ name, username, email, password, confirmPassword })
      setValidationErrors({})
      ...
      const { error } = await supabase.auth.signInWithOAuth({
        ...
        options: {
          ...
          queryParams: {
            ...
            access_type: 'offline',
            prompt: 'consent',
            // Use implicit grant type to receive tokens in the URL hash fragment
    ...
    >
      ...
      >
        ...
        <p className="text-muted-foreground text-base font-medium">
          Start your journey with Relay today
        </p>
      </motion.div>
        ...
        >
          ...
          <div className="relative group">
            ...
            <Input 
              ...
              className={cn(
                "pl-10 h-12 rounded-lg focus:border-[#3B37FE] focus:ring-[#3B37FE] transition-all duration-200 bg-background/50 backdrop-blur-sm",
                validationErrors.username && "border-destructive focus:border-destructive focus:ring-destructive"
              )}
            />
          </div>
        ...
        >
          ...
          <div className="relative group">
            ...
            <Input 
              ...
              className={cn(
                "pl-10 pr-10 h-12 rounded-lg focus:border-[#3B37FE] focus:ring-[#3B37FE] transition-all duration-200 bg-background/50 backdrop-blur-sm",
                validationErrors.confirmPassword && "border-destructive focus:border-destructive focus:ring-destructive"
              )}
            />
          </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              {isLoading ? "Creating account with Google..." : "Continue with Google"}
            </motion.span>
          </TextureButton>
        </motion.div>
      </div>
