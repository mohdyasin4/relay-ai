...
export default function SignUp() {
  ...
  return (
    <div className="bg-background grid h-svh lg:grid-cols-3 overflow-hidden">
      {/* Signup Form (Left) */}
      <motion.div
        className="flex flex-col gap-6 col-span-2 p-6 md:p-10 h-full"
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-primary-foreground/5 rounded-full blur-3xl" />
